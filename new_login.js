...
function toggle_sign_log(){
    ...
    let btn_new_text = (btn_text == "Log In <span></span><span></span><span></span><span></span>") ? "Sign Up <span></span><span></span><span></span><span></span>" : "Log In <span></span><span></span><span></span><span></span>";
    toggle_btn.innerHTML = btn_new_text;

    let msg_text = sign_log_msg.innerHTML;
    let msg_new_text = (msg_text == "Don't have an account yet?") ? "Aleready have an account?" : "Don't have an account yet?";
